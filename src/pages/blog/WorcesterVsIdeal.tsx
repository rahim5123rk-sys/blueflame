    ...
    <article className="bg-white animate-fadeIn">
      ...
      <header className="bg-slate-900 text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <span className="inline-block bg-slate-600 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 uppercase tracking-wide">Boiler Comparison</span>
          <h1 className="text-3xl md:text-5xl font-extrabold leading-tight mb-4">
            Worcester Bosch vs Ideal Boilers: Which Is Best for Your Home?
          </h1>
          <p className="text-slate-300 text-lg">By Blue Flame Gas Services · March 2026 · 7 min read</p>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl py-14">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr>
                ...
                <th className="p-4 bg-slate-800 text-white text-left border border-slate-900">Worcester Bosch</th>
                <th className="p-4 bg-gray-600 text-white text-left border border-gray-700">Ideal</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={feature} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  ...
                  <td className="p-3 border border-gray-200 text-red-700 font-medium">{wb}</td>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          {[
            ...
            <div key={model.name} className="bg-slate-50 border border-slate-200 p-4 rounded-xl">
              <p className="font-bold text-slate-800">{model.name}</p>
              <p className="text-red-700 font-bold text-lg">{model.price}</p>
        ...
        <div className="space-y-4 mb-10">
          <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-xl">
            <p className="font-bold text-amber-800 mb-1">Choose Worcester Bosch if…</p>
            <p className="text-amber-700">You want the best long-term reliability, the longest warranty, and are happy to pay a premium upfront. The Greenstar 1000 at £1,650 supply and fit is our most popular installation in Worcester homes.</p>
          </div>
        ...
        {/* Related Articles */}
        <RelatedArticles slugs={['boiler-cost-worcester', 'signs-boiler-needs-replacing']} />
        ...
        <div className="bg-slate-900 text-white p-8 rounded-2xl text-center">
          ...
          <p className="text-slate-300 mb-6">We install both Worcester Bosch and Ideal boilers across Worcester and Worcestershire. We'll recommend the right boiler for your home — not the most expensive one.</p>
