          ...
          <div className="space-y-6">
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <div className="mt-4">
                ...
                <a href="tel:07480561846" className="text-2xl font-bold text-blue-800 hover:underline">07480 561 846</a>
              </div>
              <div className="mt-4">
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input type="text" name="name" id="name" required className="mt-1 block w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-800 focus:border-blue-800" onChange={handleChange} value={formState.name} />
                </div>
                
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email Address</label>
                  <input type="email" name="email" id="email" required className="mt-1 block w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-800 focus:border-blue-800" onChange={handleChange} value={formState.email} />
                </div>

                {/* Added Phone Field */}
                <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-gray-700">Phone Number</label>
                  <input type="tel" name="phone" id="phone" required className="mt-1 block w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-800 focus:border-blue-800" onChange={handleChange} value={formState.phone} />
                </div>

                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-gray-700">Message</label>
                  <textarea name="message" id="message" rows={4} required className="mt-1 block w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-800 focus:border-blue-800" onChange={handleChange} value={formState.message}></textarea>
                </div>
