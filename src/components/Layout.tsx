            ...
            <nav className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-sm font-bold text-gray-600 hover:text-blue-800 uppercase tracking-wider transition-colors relative group"
                >
                  {link.name}
            ...
            <div className="px-4 pt-4 pb-6 space-y-2">
              {navLinks.map((link) => (
                <button
                  ...
                  className="block w-full text-left px-4 py-4 text-base font-bold text-gray-800 hover:bg-blue-50 border-b border-gray-50 last:border-0 hover:text-blue-800 transition-colors"
                >
                  {link.name}
                </button>
              ))}
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="bg-gray-800 p-3 rounded-lg hover:bg-blue-800 transition-colors group"><Facebook size={20} className="group-hover:text-white" /></a>
